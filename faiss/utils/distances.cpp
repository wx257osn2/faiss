...
#pragma omp parallel for
            for (int64_t i = i0; i < i1; i++) {
                ...
                //   is distance computations.
                auto min_distances = vdupq_n_f32(res.dis_tab[i] - x_norms[i]);
                ...
                for (; idx_j < (count / 8) * 8; idx_j += 8, ip_line += 8) {
                    ...
                    const auto distances_0 =
                            vfmaq_f32(y_norm_0, mul_minus2, ip_0);
                    const auto distances_1 =
                            vfmaq_f32(y_norm_1, mul_minus2, ip_1);
                    ...
                    // needed.
                    min_distances =
                            vbslq_f32(comparison, min_distances, distances_0);
                    min_indices =
                            vbslq_u32(comparison, min_indices, current_indices);
                    ...
                    // needed.
                    min_distances =
                            vbslq_f32(comparison, min_distances, distances_1);
                    min_indices =
                            vbslq_u32(comparison, min_indices, current_indices);
                    current_indices = vaddq_u32(current_indices, indices_delta);
                }
